...
#
if ! ./configure CC=c99 CFLAGS="-qlanglvl=extc1x -qascii -D_OPEN_THREADS=3 -D_UNIX03_SOURCE=1 -DNSIG=39 -qnose -I${AUTOMAKE_ROOT}/${AUTOMAKE_VRM}/lib,${DELTA_ROOT}/include,/usr/include" --prefix="${AUTOMAKE_PROD}" ; then
