...
#
if [ "${AUTOM4TE}x" = "x" ]; then
	export AUTOM4TE="${HOME}/zot/prod/autoconf/bin/autom4te"
fi
if [ "${AUTOMAKE_SHARE}x" = "x" ]; then
	export AUTOMAKE_SHARE="${HOME}/zot/prod/automake/share/aclocal-1.16"
fi
